...
public class ABCStoryTest {
    ...
    void TestSentenceOne() {
        ...
        Assert.assertTrue(ruleString.contains("_property(4, division, of, the_walt_disney_company)"));
        Assert.assertTrue(ruleString.contains("_property(1, logo, as, abc)"));
        Assert.assertTrue(ruleString.contains("_property(4, own, _by, disney_abc_television_group)"));
        ...
        Assert.assertTrue(ruleString.contains("_property(4, subsidiary, of, division)"));
    ...
    void TestSentenceTwo() {
        ...
        Assert.assertTrue(ruleString.contains("_property(1, part, of, network)"));
    ...
    void TestSentenceThree() {
        ...
        Assert.assertTrue(ruleString.contains("_property(2, columbus_avenue, in, manhattan)"));
        Assert.assertTrue(ruleString.contains("_property(2, columbus_avenue, with, office)"));
        Assert.assertTrue(ruleString.contains("_property(2, facility, in, burbank)"));
        Assert.assertTrue(ruleString.contains("_property(2, facility, in, los_angeles)"));
        Assert.assertTrue(ruleString.contains("_property(2, facility, in, new_york_city)"));
