...
public class AmazonRainforestStoryTest {
    ...
    void TestSentenceFour() {
        ...
        Assert.assertTrue(ruleString.contains("_property(amount, in, bolivia)"));
        Assert.assertTrue(ruleString.contains("_property(amount, in, ecuador)"));
        Assert.assertTrue(ruleString.contains("_property(amount, in, french_guiana)"));
        Assert.assertTrue(ruleString.contains("_property(amount, in, guyana)"));
        Assert.assertTrue(ruleString.contains("_property(amount, in, suriname)"));
    ...
    void TestSentenceFive() {
        ...
        Assert.assertTrue(ruleString.contains("_property(state, in, four_nation)"));
        Assert.assertTrue(ruleString.contains("_property(word, in, name)"));
    ...
    void TestSentenceSix() {
        ...
        Assert.assertTrue(ruleString.contains("_property(tract, of, tree)"));
