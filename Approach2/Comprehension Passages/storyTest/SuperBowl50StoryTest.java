...
public class SuperBowl50StoryTest {
    ...
    void TestSentenceFour() {
        ...
        Assert.assertTrue(ruleString.contains("_property(emphasize, null, suspend)"));
        Assert.assertTrue(ruleString.contains("_property(emphasize, null, tradition)"));
        Assert.assertTrue(ruleString.contains("_property(emphasize, null, know)"));
