...
public class Southern_CaliforniaStoryTest {
    ...
    void TestSentenceFive() {
        ...
        Assert.assertTrue(ruleString.contains("_property(1, center, for, state_of_california)"));
        Assert.assertTrue(ruleString.contains("_property(1, center, for, united_states)"));
